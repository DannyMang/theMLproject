...
export default function AppAppBar() {
  ...
  const handleSignIn = () => {
    // I made both buttons route to Sign up page lol, we can prob have just a single button to sign in / sign up? 
    navigate('/signin');
    setOpen(false);
  };
    ...
    >
      <Container maxWidth="lg">
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            <Button color="primary" variant="text" size="small" onClick={handleSignUp}>
              Sign in
            </Button>
